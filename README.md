...
![Tổng quan giá trị sản phẩm](diagrams/rendered/product-overview.svg)
...
![Vai trò và quyền hạn](diagrams/rendered/roles-and-permissions.svg)
...
![Hành trình nộp và duyệt bill](diagrams/rendered/submission-journey.svg)
...
![Vòng đời bill](diagrams/rendered/bill-lifecycle.svg)
...
![MVP và hướng mở rộng](diagrams/rendered/mvp-roadmap.svg)
...
## 13. Cấu trúc tài liệu trong repo
...
├── assets/
├── diagrams/
│   ├── src/        # Mã Mermaid có thể chỉnh sửa
│   └── rendered/   # SVG đã render để dùng trong README và LaTeX
└── output/pdf/     # Bản PDF hoàn chỉnh
```

Lệnh dựng lại toàn bộ diagram và PDF:
